...
/** One per AZ; auto-assigns public IPs so Fargate tasks reach the internet without a NAT gateway. */
class PublicSubnet implements Deletable, Resource
{
    ...
    public function create(): void
    {
        ...
        // 10.N.0.0/16 → 10.N.{index}.0/24, following whichever /16 the VPC claimed.
