...
/**
 * Follow-tail keeps logs pinned to the newest line until the operator scrolls
 * up, then re-arms when they scroll back to the bottom.
 */
class Viewport
{
    ...
    /**
     * The offset is re-clamped every render, so a resize or a shrunk list can never strand it.
     *
    ...
    public function window(array $lines, int $height): array
    {
        ...
        // Reaching the bottom — by scroll or by clamp — re-arms tail-following.
