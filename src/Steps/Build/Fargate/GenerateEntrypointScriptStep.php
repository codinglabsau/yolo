...
class GenerateEntrypointScriptStep implements Step
{
    ...
    public function __invoke(): StepResult
    {
        ...
        $drain = (new TargetGroup())->deregistrationDelay();
        ...
        // the deregistration-delay window before forwarding the stop, so requests the
        // ALB sends mid-drain still land on a live server instead of 502ing.
        $body .= sprintf(<<<'SH'
