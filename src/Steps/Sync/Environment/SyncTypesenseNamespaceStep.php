...
/**
 * LongRunning: namespace creation/deletion is an async Cloud Map operation the
 * resource blocks on — the next step resolves the namespace id. Teardown
 * cascades the discovery services first (see PrivateDnsNamespace::delete()).
 */
