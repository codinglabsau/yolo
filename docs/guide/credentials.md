...
The argument is the 1Password item name; an optional second argument names the vault (default `Employee`). It needs the [1Password CLI](https://developer.1password.com/docs/cli/) (`op`), the AWS CLI, and `jq` — on macOS:
